...
use App\Http\Controllers\Tenant\OdontogramController;
...
if ($hostname) {
    Route::domain($hostname->fqdn)->group(function () {
        ...
        Route::prefix('odontogram')->name('tenant.odontogram.')->group(function () { Route::get('/', [OdontogramController::class, 'index'])->name('index');});
