        ...
        <div class="nano-content nano-content-mobile">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main nav-main-mobile">
                    ...
                    {{-- ODONTOLOGIA --}}
                    @if(in_array('odontology', $vc_modules))
                        <li 
                            class="nav-parent 
                                                                    {{ $firstLevel === 'Odontogram' ? 'nav-active nav-expanded' : '' }}
                                                                    ">
                            <a class="nav-link" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" class="icon icon-tabler icon-tabler-tooth">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                <path d="M5 11c0 -5.523 2 -8 7 -8s7 2.477 7 8c0 6 -2 9 -3.5 9c-1.046 0 -1.5 -2 -3.5 -2s-2.454 2 -3.5 2c-1.5 0 -3.5 -3 -3.5 -9z" />
                            </svg>
                                <span>Odontología</span>
                            </a>
                            <ul class="nav nav-children">
                                @if(in_array('odontogram', $vc_module_levels))
                                    <li class="{{ $firstLevel === 'Odontogram' ? 'nav-active nav-expanded' : '' }}">
                                        <a class="nav-link" href="{{ route('tenant.odontogram.index') }}">ODONTOGRAMA</a>
                                    </li>
                                @endif
                            </ul>
                        </li>
                        ...
                        <li
                            ...
                            <ul class="nav nav-children">
                                @if(in_array('ecommerce', $vc_module_levels))
                                    <li class="">
                                        <a class="nav-link" onclick="window.open('{{ route('tenant.ecommerce.index') }}')">Ir a Tienda
